...
import 'package:news/AppCore/extensions/dateFormatter_extentions.dart';
import 'package:provider/provider.dart';

import '../../AppCore/providers/ThemeProvider.dart';
import 'widgets/SelectedArticlePanel.dart';
    ...
    return InkWell(
      onTap: () {
        showModalBottomSheet(
          ...
          builder: (context) => SelectedArticlePanel(article: articleModel),
        );
      },
      child: Container(
